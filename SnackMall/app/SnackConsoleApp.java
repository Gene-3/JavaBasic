...
public class SnackConsoleApp {
    ...
    private void login() {
        ...
        // 관리자 로그인 시 별도 DB 확인 없이 고정값으로 로그인 처리
    ...
    private void showAdminMenu() {
        ...
        Integer choice = inputInt("선택> ", 0, 9);
    ...
    private void showUserMenu() {
        ...
        Integer choice = inputInt("선택> ", 0, 5);
        if (choice == null) return;
    ...
    // 정수 입력 처리, b 입력 시 null 반환(뒤로가기 기능)
